...
import org.wrn.shortlink.project.config.GotoDomainWhiteListConfiguration;
import org.wrn.shortlink.project.dao.entity.*;
import org.wrn.shortlink.project.dao.mapper.*;
import org.wrn.shortlink.project.dto.biz.ShortLinkStatsRecordDTO;
...
import org.wrn.shortlink.project.dto.resp.*;
import org.wrn.shortlink.project.mq.producer.DelayShortLinkStatsProducer;
...
import static org.wrn.shortlink.project.common.constant.RedisKeyConstant.*;
import static org.wrn.shortlink.project.common.constant.ShortLinkConstant.AMAP_REMOTE_URL;
...
public class ShortLinkServiceImpl extends ServiceImpl<ShortLinkMapper, ShortLinkDO> implements ShortLinkService {
    ...
    public void updateShortLink(ShortLinkUpdateReqDTO requestParam) {
        ...
        if (!java.util.Objects.equals(hasShortLinkDO.getValidDateType(), requestParam.getValidDateType())
                || !java.util.Objects.equals(hasShortLinkDO.getValidDate(), requestParam.getValidDate())) {
            stringRedisTemplate.delete(String.format(GOTO_SHORT_LINK_KEY, requestParam.getFullShortUrl()));
            if (hasShortLinkDO.getValidDate() != null && hasShortLinkDO.getValidDate().before(new Date())) {
                if (java.util.Objects.equals(requestParam.getValidDateType(), VailDateTypeEnum.PERMANENT.getType()) || requestParam.getValidDate().after(new Date())) {
    ...
    private void shortLinkStats(String fullShortUrl, String gid, ServletRequest request, ServletResponse response) {
        ...
        try {
            ...
            Map<String, Object> localeParamMap = new HashMap<String, Object>();
